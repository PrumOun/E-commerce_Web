...
import { applyBackgroundImages, initializeProductFilter, } from "../utils";
...
const Home = () => {
    useEffect(() => {
        // Apply background images to elements with the `set-bg` class
        applyBackgroundImages();
        initializeProductFilter(".product__filter", ".filter__controls");
                                        ...
                                        <div className="product__item__text">
                                            ...
                                            <div className="rating">
                                                {[...Array(5)].map((_, i) => (
                                                    <i
                                                        key={i}
                                                        className={`fa ${i < Math.round(product.rating?.rate || 0) ? 'fa-star field' : 'fa-star-o'}`}
                                                    ></i>
                                                ))}
                                            </div>
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="blog__item">
                                ...
                                <div className="blog__item__text">
                                    ...
                                    <h5>Eternity Bands Do Last htmlForever</h5>
                                    <a href="#">Read More</a>
                                </div>
                            </div>
                        </div>
